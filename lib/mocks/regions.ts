...
/** Canonical mock region catalog — replace with API-backed list via BFF when wired. */
export const MOCK_REGIONS: Record<string, Region> = {
  new_cairo: {
    id: 'new_cairo',
...
export async function listRegionsMock(): Promise<Region[]> {
